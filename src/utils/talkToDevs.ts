...
export const talkToDevs = (): void => {
  ...
  if (!Object.prototype.hasOwnProperty.call(window, 'inspiration')) {
  ...
  if (!Object.prototype.hasOwnProperty.call(window, 'geekies')) {
    Object.defineProperty(window, 'geekies', {
      get() {
        fetch(
          'https://raw.githubusercontent.com/yannklein/prog-quotes/main/quotes.json',
        )
          .then((r) => r.json())
          .then((data) => {
  ...
  if (!Object.prototype.hasOwnProperty.call(window, 'yanns_email')) {
    Object.defineProperty(window, 'yanns_email', {
      get() {
        setTimeout(
          () => console.log('%cyann.klein [at] me.com', answerStyle),
          500,
        );
        return 'Here you go:';
      },
